...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::resource('brands', BrandController::class);
        //currency change 
    Route::resource('currencychanges', CurrencyChangeController::class);
    ...
    // Purchase Import and export
    // Route::get('export-purchases', 'PurchaseController@exportPurchase');
    Route::get('export-purchases', [PurchaseController::class, 'exportPurchase']);

    Route::post('import-purchases', [PurchaseController::class, 'ImportPurchase']);
    ...
    // Route::get('/export-sales', [ImportSalesController::class, 'ExportIndex']);

    Route::get('/export-sales', [ImportSalesController::class, 'StoreExport'])->name('export.sales');

    //Zaheer END Export

    Route::get('/sells/pos/get_product_row/{variation_id}/{location_id}/{selectedValue?}', [SellPosController::class, 'getProductRow']);
    ...
    Route::get('/pos-location', [SellPosController::class , 'getlocationId']);
    ...
    Route::get('/reports/get-kot', [ReportController::class, 'getkot']);
    
    Route::get('/reports/oder_reports', [ReportController::class, 'oder_reports']);
    ...
    // Zaheer
    Route::post('/save-data-stock', [ReportController::class, 'EnterStock']);
    
    // Route::post('/reports/save-data', 'ReportController@saveData')->name('reports/save-data');
    // End 
    ...
    Route::get('/kot/{id}', [IdController::class , 'kot']);
    Route::get('/kot_last', [SellPosController::class , 'kot_last']);
    Route::get('/kot_bill_ids',  [IdController::class , 'kot_bill_ids']);
    Route::get('/kot_bill_pos', [IdController::class , 'kot_bill_pos']);
    Route::get('/sellpos',[IdController::class , 'index']);
    Route::get('/bill/{id}', [IdController::class , 'bill']);
