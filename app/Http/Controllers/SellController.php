    ...
    {   
        ...
        if (request()->ajax()) {
            ...
            if (! empty(request()->suspended)) {
                ...
                return view('sale_pos.partials.suspended_sales_modal')->with(compact('sales', 'is_tables_enabled', 'is_service_staff_enabled', 'transaction_sub_type' , 'pos_settings'));
            }
