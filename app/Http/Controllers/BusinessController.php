    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $checkboxes = ['enable_editing_product_from_purchase',
                'enable_inline_tax','enable_unit_purchase_price',
                'enable_brand', 'enable_category', 'enable_sub_category', 'enable_price_tax', 'enable_purchase_status',
                'enable_lot_number', 'enable_racks', 'enable_row', 'enable_position', 'enable_sub_units', 'enable_purchase_imei' , 'enable_is_flex' , 'enable_is_other_currency'];
            ...
            //flex
            $business_details['enable_is_flex'] = !empty($business_details['enable_is_flex']) ? $this->businessUtil->num_uf($business_details['enable_is_flex']) : 0;
