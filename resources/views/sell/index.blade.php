...
<section class="content no-print">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'lang_v1.all_sales')])
     ...
     {{-- <div class="col-sm-6"> --}}
        ...
        <a href="{{action([\App\Http\Controllers\ImportSalesController::class, 'StoreExport'])}}" class="btn btn-block btn btn-success">Export Sell</a>
...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        columns: [
            ...
            { data: 'address_line_1', name: 'contacts.address_line_1'},
