    ...
    <div class="modal-body">
      ...
      @endif
         ...
         <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" id='cat_edit_image'/>
          <input type="hidden" class="form-control" name="old_img" value="{{asset('uploads/img/'. $category->image)}}"/>
   
          @if ($category->image == 'undefined' || $category->image == null )
   
          <img src="{{asset('uploads/img/download.png')}}" alt="" srcset="" style="width:25%;">
           
           @else
           <img src="{{asset('uploads/img/'. $category->image)}}" alt="" srcset="" style="width:25%;">
         @endif
