<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('location_id', __('Business Location').':*') !!} <br/>
        <select name="location_id" class="form-control" required>
          <option selected>Please Select</option>
          @foreach($business_locations as $key => $b)
          <option value="{{$b["id"]}}">{{$b['location_id']}}</option>
        @endforeach
        </select>
  </div>
  ...
  <div class="form-group">
    ...
    {!! Form::file('image', ['class' => 'form-control', 'id'=>'cat_image']); !!}
  </div>
