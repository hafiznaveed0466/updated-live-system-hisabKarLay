            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('mobile', null, ['class' => 'form-control', 'required', 'placeholder' => __('contact.mobile') , 'pattern' => '[0-9]+']); !!}
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div id="more_div" class="hide">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('Area:') !!}
                        {!! Form::text('area', null, ['class' => 'form-control', 'placeholder' => __('area'), 'rows' => 3]); !!}
                    </div>
                </div>
