        ...
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                scrollCollapse: true,
                    ...
                    { extend: 'excel', text: '<i class="fa fa-file-excel" aria-hidden="true"></i> Export to EXCEL' },
                    ...
                    { extend: 'colvis', text: '<i class="fa fa-columns" aria-hidden="true"></i>  Column visibility' },
                    {
                                ...
                                exportOptions: {
                                    columns: ':visible:not(:eq(0))', // Exclude the first visible column
                                    rows: ':not(:eq(1))' ,
                                }
                            },
                ],
                        columnDefs: [
                            // Hide the column with index 0
                ...
                columns: [
                        ...
                        @if(!empty(session()->get('business.common_settings.enable_product_enter_stock_diff')))
                            { data: 'enter_stock', searchable: false},
