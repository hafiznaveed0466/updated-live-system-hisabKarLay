    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[enable_due_dates]', 1,  
                   empty($pos_settings['enable_due_dates']) ? 0 : 1 , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_pos_due_dates' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[print_kot]', 1,  
                        !empty($pos_settings['print_kot']) , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Print kot' ) }}
                  </label>
                </div>
            </div>
        </div>
        ...
        {{-- quotation --}}
         <div class="col-md-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[quotation]', 1,  
                        !empty($pos_settings['quotation']) , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Quotation Button' ) }}
                  </label>
                </div>
            </div>
        </div>
 ...
 <div class="col-sm-3">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
                            'pos_settings[show_kot_button]',
                            1,
                            !empty($pos_settings['show_kot_button']),
                            ['class' => 'input-icheck'],
                        ) !!} {{ __('Suspend Kot Bill Button') }}
                    </label>
                </div>
            </div>
        </div>

            {{-- Disable Cross Button For Specific User --}}
        <div class="col-md-6">
            <div class="form-group">
                <div class="checkbox">
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[disable_rem_button]', 1,  
                        !empty($pos_settings['disable_rem_button']) , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Disable Cross Button For Specific User' ) }}
                  </label>
                </div>
            </div>
        </div>
         ...
         <div class="col-sm-6">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
                            'pos_settings[register_date]',
                            1,
                            !empty($pos_settings['register_date']),
                            ['class' => 'input-icheck'],
                        ) !!} {{ __('Register Start Date') }}
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
                            'pos_settings[service_charge]',
                            1,
                            !empty($pos_settings['service_charge']),
                            ['class' => 'input-icheck'],
                        ) !!} {{ __('Service Charge') }}
                    </label>
                </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        ...
                        <label>
                            {!! Form::checkbox(
                                'pos_settings[print_roll]',
                                1,
                                empty($pos_settings['print_roll']) ? 0 : 1,
                                ['class' => 'input-icheck'],
                            ) !!} {{ __('print roll') }}
                        </label>
                    </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <div class="checkbox">
                        ...
                        <label>
                            {!! Form::checkbox(
                                'pos_settings[enable_pos_whole_sale_screen]',
                                1,
                                empty($pos_settings['enable_pos_whole_sale_screen']) ? 0 : 1,
                                ['class' => 'input-icheck'],
                            ) !!} {{ __('Enable Pos WholeSale') }}
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="checkbox">
                        ...
                        <label>
                            {!! Form::checkbox(
                                'enable_is_flex',
                                1,
                                empty($business->enable_is_flex) ? 0 : 1,
                                ['class' => 'input-icheck'],
                            ) !!} {{ __('Is Flex') }}
                        </label>
                    </div>
         ...
         <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
                            'enable_is_other_currency',
                            1,
                            empty($business->enable_is_other_currency) ? 0 : 1,
                            ['class' => 'input-icheck'],
                        ) !!} {{ __('Sale In Other Currency') }}
                    </label>
                </div>
            </div>
        </div>
