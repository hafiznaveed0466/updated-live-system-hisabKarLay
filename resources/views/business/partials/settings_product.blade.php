<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        {{-- Stock report and products diff by zaheer--}}

        <div class="col-sm-4">
          <div class="form-group">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('common_settings[enable_product_enter_stock_diff]', 1, !empty($common_settings['enable_product_enter_stock_diff']) ? true : false, 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'Enable Product Enter Stock Diff' ) }}
                </label>
              </div>
          </div>
      </div>
