<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-8">
           ...
           {{-- Purcahse Price By zaheer --}}
           <div class="col-sm-12">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('enable_unit_purchase_price', 1, $business->enable_unit_purchase_price, 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'Enable Unit Purcahse Price' ) }}
                  </label>
                </div>
            </div>
        </div>
