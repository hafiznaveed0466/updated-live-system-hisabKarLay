...
<div class="clearfix"></div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="checkbox">
                <label>
                {!! Form::checkbox('common_settings[enable_purchase_imei]', 1 , !empty($common_settings['enable_purchase_imei']) , [ 'class' => 'input-icheck', 'id' => 'enable_purchase_imei']); !!} {{ __( 'Enable Purchase IMEI Numbers' ) }}
                </label>
              {{-- @show_tooltip(__('lang_v1.purchase_requisition_help_text')) --}}
            </div>
        </div>
