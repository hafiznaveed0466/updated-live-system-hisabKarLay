...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			{{-- quotation --}}
			@if (empty($pos_settings['quotation']))
			...
			@if(isset($pos_settings['print_kot']));
			<button type="button" class="btn btn-success asad asad pull-right margin-r-5  @if($is_mobile) col-xs-5 @endif" ><i class="fas fa-arrow-alt-circle-down"></i>
				KOT</button>
			@endif
...
@include('sale_pos.partials.demo')