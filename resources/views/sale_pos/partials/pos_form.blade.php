<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <h5 class="text-danger hide contact_due_text"><strong>@lang('account.customer_due'):</strong> <span></span></h5>
        </div>
    </div>
    <div class="col-md-8">
        <div class="form-group">
...
<div class="row">
    ...
    ?>
    @if (!empty($pos_settings['enable_due_dates']))
        <div class="col-md-5 col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('due_dates', $default_datetime, [
                        'class' => 'form-control',
                        'required',
                        'readonly',
                        'id' => 'due_date',
    ...
    @if (in_array('types_of_service', $enabled_modules) && !empty($types_of_service))
        <div class="col-md-4 col-sm-6">
            ...
            <!--service_charge-->
		@if(!empty($pos_settings['service_charge']))
		<div class="modal fade types_of_service_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" style="dispaly:none"></div>
	    @endif
	<!--end -->
        ...
        <table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
            <thead>
                <tr>
                    ...
                    @if ($business_details->enable_is_flex)
                        <th class="text-center col-md-3">
                            <!--@lang('lang_v1.is_flex')-->
                            Size
                        </th>
                        <th class="text-center col-md-3" >
                            {{-- @lang('lang_v1.qty_flex') --}}
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::textarea('sale_note_whole_sale', !empty($transaction) ? $transaction->additional_notes : null, [
                    'class' => 'form-control sale_note',
                    'rows' => 3,
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::textarea('staff_note_whole_sale', !empty($transaction) ? $transaction->staff_note : null, [
                    'class' => 'form-control',
                    'rows' => 3,
