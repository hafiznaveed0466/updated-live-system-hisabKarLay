...
@if (Auth::user()->business_id == 2)
	...
	@includeIf('sale_pos.receipts.partial.new_report_mx')
@else
<div class="row">
        ...
        <table class="table table-responsive table-slim">
            <thead>
                <tr>
                    ...
                    <th class="text-right" width="10%">Width</th>
    ...
    <div class="col-xs-6">
        ...
        <table class="table table-slim">
            ...
            @if (!empty($receipt_details->all_due))
                ...
                <tr>
                    <th>
                        {{ __("Previews customer due")}}
                    </th>
                    <td class="text-right">

                        @php
                        
                            $total_due = $receipt_details->total_due;
                            $all_due = $receipt_details->all_due;
                           
                            $value1 = (float) str_replace(['₨ ', ','], '', $all_due);
                            $value2 = (float) str_replace(['₨ ', ','], '', $total_due);
                          
                            $Previews_customer_due = $value1 - $value2;

                            $Previews_customer_due_formatted = 'Rs.' . number_format($Previews_customer_due, 2);

                            
                        @endphp

                        {{ $Previews_customer_due_formatted }}
                    </td>
                </tr>
