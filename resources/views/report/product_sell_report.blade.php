    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                {!! Form::open([
                    'url' => action('App\Http\Controllers\ReportController@getStockReport'),
                    'method' => 'get',
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(
        '#user_id ,#product_sell_report_form #location_id, #product_sell_report_form #customer_id, #psr_filter_brand_id, #psr_filter_category_id, #psr_customer_group_id'
    ).change(function() {
